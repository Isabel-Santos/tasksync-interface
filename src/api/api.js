...
// export const verify2FA = async (email, code) => {
//   // --- DIAGNÓSTICO ---
//   console.log('[API.JS] Tentando verificar 2FA com:', { email, code });
  
//   const response = await api.post('/auth/verify-2fa', { email, code });
  
//   // --- DIAGNÓSTICO ---
//   console.log('[API.JS] Resposta recebida do servidor:', response.data);

//   if (!response.data?.access_token) {
//     // Lança um erro para ser capturado pelo formulário.
//     throw new Error(response.data?.message || 'Código inválido ou resposta inesperada do servidor.');
//   }
...
// A URL da rota de atualização foi corrigida para corresponder ao que o backend espera.
export const updateTask = (id, data) => api.put(`/tasks/${id}/update`, data);
// --- FIM DA CORREÇÃO ---
